...
<script type="text/javascript" charset="utf-8">
     ...
     $(document).ready(function() {
               ...
               if (data_list_pub != null){
                    ...
                    for(var i=0; data_list_pub[i]; i++)
                    {
                        ...
                        data_table_html += '<tr class="">\n\
                                             ...
                                             <td class="island">'+data_list_pub[i][1]+'</td>\n\\n\
                                             <td class="spent-time center">'+data_list_pub[i][2]+'</td>\n\
                                            </tr>';
         ...
         $('#publisher_table_container').html(data_table_html);
          ...
          $('#publisher_table_container .dataTable').after('<div class="pub_total_unique_downloads"><label class="total-caption">total</label> <label class="pub_download_min">'+total_down+'</label> <label class="total-caption">minutes</label> </div>');
